...
class OF_Const {
   public:
    ...
    const std::unordered_map<std::string_view, int> boolTypes_Strings = {
        {"CustomPins", customPins},   {"Rumble", rumble},
        {"Solenoid", solenoid},       {"Autofire", autofire},
        {"SimplePause", simplePause}, {"HoldToPause", holdToPause},
        {"LEDAnode", commonAnode},    {"LowButtons", lowButtonsMode},
        {"RumbFFB", rumbleFF},        {"InvertStaticPixels", invertStaticPixels},
        {"I2COLEDEnabled", i2cOLED},  {"I2COLEDAltAddr", i2cOLEDaltAddr},
    };
    ...
    const std::unordered_map<std::string_view, int> settingsTypes_Strings = {
        {"RumbPwr", rumbleStrength},        {"RumbTime", rumbleInterval},      {"SolOn", solenoidOnLength},
        {"SolOff", solenoidOffLength},      {"SolHold", solenoidHoldLength},   {"HoldToPauseLength", holdToPauseLength},
        {"CtmPixelsCount", customLEDcount}, {"StaticPixels", customLEDstatic}, {"StaticColor1", customLEDcolor1},
        {"StaticColor2", customLEDcolor2},  {"StaticColor3", customLEDcolor3}, {"TempWarning", tempWarning},
        {"TempDanger", tempShutdown},       {"AnalogMode", analogMode},
    };

    enum { analogModeStick = 0, analogModeDpad, analogModeKeys } analogModeSettings_e;
    ...
    const std::unordered_map<std::string_view, std::vector<int>> boardsPresetsMap = {
        ...
        {"seeed-xiao-esp32c6", {/*00*/ btnGunRight, btnGunDown,  btnGunC,     btnUnmapped, btnPump,
                                /*05*/ rumblePin,   periphSDA,   periphSCL,   btnUnmapped, btnUnmapped,
                                /*10*/ btnUnmapped, btnUnmapped, btnUnmapped, btnUnmapped, btnUnmapped,
                                /*15*/ btnUnmapped, btnGunB,     solenoidPin, camSCL,      btnTrigger,
                                /*20*/ camSDA,      btnGunUp,    btnGunLeft,  btnGunA,     btnUnmapped,
...
// Only needed for the Desktop App, don't build for microcontroller firmware!
    ...
    const std::unordered_map<std::string_view, std::vector<int>> mcuCapableMaps = {
        ...
        {boardArchs[boardRP],
         {/*00*/ pinI2C0SDA | pinSPI0RX,
          pinI2C0SCL | pinSPI0CSn,
          pinI2C1SDA | pinSPI0SCK,
          pinI2C1SCL | pinSPI0TX,
          pinI2C0SDA | pinSPI0RX,
          /*05*/ pinI2C0SCL | pinSPI0CSn,
          pinI2C1SDA | pinSPI0SCK,
          pinI2C1SCL | pinSPI0TX,
          pinI2C0SDA | pinSPI1RX,
          pinI2C0SCL | pinSPI1CSn,
          /*10*/ pinI2C1SDA | pinSPI1SCK,
          pinI2C1SCL | pinSPI1TX,
          pinI2C0SDA | pinSPI1RX,
          pinI2C0SCL | pinSPI1CSn,
          pinI2C1SDA | pinSPI1SCK,
          /*15*/ pinI2C1SCL | pinSPI1TX,
          pinI2C0SDA | pinSPI0RX,
          pinI2C0SCL | pinSPI0CSn,
          pinI2C1SDA | pinSPI0SCK,
          pinI2C1SCL | pinSPI0TX,
          /*20*/ pinI2C0SDA | pinSPI0RX,
          pinI2C0SCL | pinSPI0CSn,
          pinI2C1SDA | pinSPI0SCK,
          pinI2C1SCL | pinSPI0TX,
          pinI2C0SDA | pinSPI1RX,
          /*25*/ pinI2C0SCL | pinSPI1CSn,
          pinI2C1SDA | pinSPI1SCK | pinHasADC,
          pinI2C1SCL | pinSPI1TX | pinHasADC,
          pinI2C0SDA | pinSPI1RX | pinHasADC,
          pinI2C0SCL | pinSPI1CSn | pinHasADC,
          /*30*/ pinI2C1SDA | pinSPI1SCK,
          pinI2C1SCL | pinSPI1TX,
          pinI2C0SDA | pinSPI0RX,
          pinI2C0SCL | pinSPI0CSn,
          pinI2C1SDA | pinSPI0SCK,
          /*35*/ pinI2C1SCL | pinSPI0TX,
          pinI2C0SDA | pinSPI0RX,
          pinI2C0SCL | pinSPI0CSn,
          pinI2C1SDA | pinSPI0SCK,
          pinI2C1SCL | pinSPI0TX,
          /*40*/ pinI2C0SDA | pinSPI1RX | pinHasADC,
          pinI2C0SCL | pinSPI1CSn | pinHasADC,
          pinI2C1SDA | pinSPI1SCK | pinHasADC,
          pinI2C1SCL | pinSPI1TX | pinHasADC,
          pinI2C0SDA | pinSPI1RX | pinHasADC,
          /*45*/ pinI2C0SCL | pinSPI1CSn | pinHasADC,
          pinI2C1SDA | pinSPI1SCK | pinHasADC,
          pinI2C1SCL | pinSPI1TX | pinHasADC}},
        //====================================================
        ...
        {boardArchs[boardESP32_S3],
         {/*00*/ pinSystem,
          ...
          pinHasADC | pinAnyI2C | pinAnySPI,
          pinHasADC | pinAnyI2C | pinAnySPI,
          /*10*/ pinHasADC | pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          ...
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          /*35*/ pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          /*40*/ pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
          pinAnyI2C | pinAnySPI,
    ...
    ///             (Yep, bitpacking! Three least significant bits of the second byte determine left/right/under
    ///             position) (If anyone is aware of a better way of doing this, please let me know/send a PR!)
    const std::unordered_map<std::string_view, std::vector<unsigned int>> boardsBoxPositions = {
        ...
        // Board Type: ESP32-S3
        {"waveshare-esp32-s3-pico",
         {/*00*/ posNothing,    17 | posRight, 16 | posRight, posNothing,   15 | posRight,
        ...
        // SeeedStudio XIAO ESP32-C6
        // Board Type: ESP32-C6
        {"seeed-xiao-esp32c6", {/*00*/ 1 | posLeft,  2 | posLeft,   3 | posLeft,
                                posNothing,          4 | posLeft,
                                /*05*/ 5 | posLeft,  6 | posLeft,   7 | posLeft,
                                posNothing,          posNothing,
                                /*10*/ posNothing,   posNothing,    posNothing,
                                posNothing,          posNothing,
                                /*15*/ posNothing,   10 | posRight, 9 | posRight,
                                8 | posRight,        7 | posRight,
                                /*20*/ 6 | posRight, 5 | posRight,  4 | posRight,
                                3 | posRight,        posNothing,
                                /*25*/ posNothing,   posNothing,    posNothing,
                                posNothing,          posNothing}},  // trimmed to 30 GPIO (0-29)
        //=====================================================================================================================
        // Insert new ESP layouts below this one!
        // Feel free to use any of the above as a template.
        // ***
    ...
    /// @details    Key = board (one board can be multiple), string literal label, int array maps to RP2040 GPIO where
    /// each value is a FW function (or unmapped).
    const std::unordered_multimap<std::string_view, boardAltPresetsMap_t> boardsAltPresets = {
        ...
        */
        ...
        // Notes: pins 13-17 & 21-23 are unexposed
        {"adafruitItsyRP2040",
         {"SAMCO 2.0 (Btn C as Home)",
          {btnUnmapped, btnUnmapped, camSDA,      camSCL,      btnPedal,    btnUnmapped, btnTrigger,  btnGunDown,
           btnGunLeft,  btnGunUp,    btnGunRight, btnHome,     btnUnmapped, unavailable, unavailable, unavailable,
           unavailable, unavailable, btnUnmapped, btnUnmapped, btnUnmapped, unavailable, unavailable, unavailable,
           rumblePin,   solenoidPin, btnGunB,     btnGunA,     btnStart,    btnSelect}}},

        {"adafruitItsyRP2040",
         {"SAMCO 1.1",
          {btnUnmapped, btnUnmapped, camSDA,      camSCL,      btnUnmapped, btnUnmapped, btnGunA,     btnGunB,
           rumblePin,   btnHome,     btnTrigger,  btnUnmapped, btnUnmapped, unavailable, unavailable, unavailable,
           unavailable, unavailable, btnUnmapped, btnUnmapped, btnUnmapped, unavailable, unavailable, unavailable,
           btnUnmapped, btnUnmapped, btnUnmapped, btnPedal,    btnUnmapped, btnUnmapped}}},
    };
